...
public:
	...
	virtual double GetHeight(const vector3d &) const override final { return 0.0; }
	...
	static void SetRenderTargetCubemap(const uint32_t, Graphics::Texture *, const bool unBind = true);
