...
DECLARE_STRING(LATITUDE_NORTH_ABBREV)
DECLARE_STRING(LATITUDE_SOUTH_ABBREV)
DECLARE_STRING(LONGITUDE_EAST_ABBREV)
DECLARE_STRING(LONGITUDE_WEST_ABBREV)
DECLARE_STRING(UNIT_METERS_PER_SECOND)
DECLARE_STRING(UNIT_KILOMETERS_PER_SECOND)
DECLARE_STRING(UNIT_MILLION_METERS_PER_SECOND)
DECLARE_STRING(MOUSE_WHEEL)
DECLARE_STRING(UP)
DECLARE_STRING(DOWN)
DECLARE_STRING(LEFT)
DECLARE_STRING(RIGHT)
