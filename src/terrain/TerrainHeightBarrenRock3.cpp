...
double TerrainHeightFractal<TerrainHeightBarrenRock3>::GetHeight(const vector3d &p) const
{
	...
	float n = 0.07 * voronoiscam_octavenoise(12, std::clamp(fabs(0.165 - (0.38 * river_octavenoise(12, 0.4, 2.5, p))), 0.15, 0.5), std::clamp(8.0 * billow_octavenoise(12, 0.37, 4.0, p), 0.5, 9.0), p);
